...
const Navigations = () => {
  ...
  const [currentUser, setCurrentUser] = useState(null); // Mocking currentUser for UI design
  ...
  // Dummy logout function for UI purpose
  const handleLogout = () => {
    setCurrentUser(null); // Resetting currentUser to mock logout
  };
